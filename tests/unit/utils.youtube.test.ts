...
import { channelUrl, extractYoutubeId, searchUrl, shortUrl, watchUrl } from '../../src/shared/utils/youtube';
...
describe('YouTube URL utilities', () => {
    describe('extractYoutubeId', () => {
        ...
        test('returns null for overly long URLs', () => {
            const longUrl = 'https://www.youtube.com/watch?v=dQw4w9WgXcQ&' + 'a'.repeat(2048);
