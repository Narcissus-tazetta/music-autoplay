...
export function normalizeYoutubeMeta(
  ...
  let title: string | undefined =
    typeof m.title === "string" ? m.title : undefined;
  let channelTitle: string | undefined =
    typeof m.channelTitle === "string" ? m.channelTitle : undefined;
  let channelId: string | undefined =
    typeof m.channelId === "string" ? m.channelId : undefined;
  let durationRaw: string | number | undefined =
    typeof m.duration === "string" ? m.duration : undefined;
  if (typeof m.duration === "number") durationRaw = m.duration;
  let isAgeRestricted: boolean | undefined =
    typeof m.isAgeRestricted === "boolean" ? m.isAgeRestricted : undefined;
  ...
  if (
    ...
    if (!channelId && snippet && typeof snippet.channelId === "string")
      channelId = snippet.channelId;

    if (contentDetails && typeof contentDetails.duration === "string")
  ...
  if (typeof durationRaw === "string" && m.raw && typeof m.raw === "object") {
    ...
    if (rawObj.contentDetails && typeof rawObj.contentDetails === "object")
      durationFromRaw = true;
  }
