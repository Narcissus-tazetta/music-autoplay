...
const TimePageLayout = ({ status }: TimePageLayoutProps) => {
    ...
    // dark class now applied globally on <html> by ThemeInitializer/store
    ...
    const setBackgroundFeatureEnabled = useProgressSettingsStore((s) => s.setBackgroundFeatureEnabled);
    ...
    return (
        <>
            <div className={`min-h-screen bg-base-200 flex items-center justify-center p-4`} style={finalStyle}>
                <SettingsButton
                    onClick={() => {
