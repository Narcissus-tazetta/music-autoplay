...
const TimePageLayout = ({ status }: TimePageLayoutProps) => {
  ...
  const showRemainingText = useProgressSettingsStore(
    (s) => s.showRemainingText,
  );
  const setShowRemainingText = useProgressSettingsStore(
    (s) => s.setShowRemainingText,
  );
  const showCurrentSchedule = useProgressSettingsStore(
    (s) => s.showCurrentSchedule,
  );
  const setShowCurrentSchedule = useProgressSettingsStore(
    (s) => s.setShowCurrentSchedule,
  );
  ...
  // Background settings
  const showBackgroundImage = useProgressSettingsStore(
    (s) => s.showBackgroundImage,
  );
  const setShowBackgroundImage = useProgressSettingsStore(
    (s) => s.setShowBackgroundImage,
  );
  const backgroundImageFileName = useProgressSettingsStore(
    (s) => s.backgroundImageFileName,
  );
  const backgroundFeatureEnabled = useProgressSettingsStore(
    (s) => s.backgroundFeatureEnabled,
  );
