...
import { timeToMs, getCurrentTimeMs } from "../utils/time-calculations";
                ...
                <tr key={index} className={getRowClass(item, index)}>
                  ...
                  <td className="font-semibold">
                    {isCurrentItem(item, index) && (
                      <span className="badge badge-xs badge-primary mr-2">NOW</span>
                    )}
                    {item.label}
                  </td>
                  <td>
                    <div className="flex items-center gap-2">
                      ...
                      <span
                        className={`badge badge-sm ${
                          item.type === "class" ? "badge-primary" : "badge-secondary"
                        }`}
                      >
