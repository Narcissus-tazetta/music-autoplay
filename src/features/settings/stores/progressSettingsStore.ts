...
interface ProgressSettingsState {
  ...
  updateSettings: (
    values: Partial<Omit<ProgressSettingsState, "updateSettings">>,
  ) => void;
}
...
export const useProgressSettingsStore = create<ProgressSettingsState>()(
  persist(
    (set) => ({
      ...
      setProgressColor(color: ProgressColor) {
        set({ progressColor: color });
      },
      setShowRemainingText(value: boolean) {
        set({ showRemainingText: value });
      },
      setShowCurrentSchedule(value: boolean) {
        set({ showCurrentSchedule: value });
      },

      setShowDate(value: boolean) {
        set({ showDate: value });
      },
      setShowYear(value: boolean) {
        set({ showYear: value });
      },
      setShowMonth(value: boolean) {
        set({ showMonth: value });
      },
      setShowDay(value: boolean) {
        set({ showDay: value });
      },
      setShowWeekday(value: boolean) {
        set({ showWeekday: value });
      },
      setYearFormat(value: YearFormat) {
        set({ yearFormat: value });
      },
      setMonthFormat(value: MonthFormat) {
        set({ monthFormat: value });
      },
      setDayFormat(value: DayFormat) {
        set({ dayFormat: value });
      },
      setWeekdayFormat(value: WeekdayFormat) {
        set({ weekdayFormat: value });
      },

      setShowBackgroundImage(value: boolean) {
        set({ showBackgroundImage: value });
      },
      setBackgroundImageFileName(value: string) {
        set({ backgroundImageFileName: value });
      },
      setBackgroundFeatureEnabled(value: boolean) {
