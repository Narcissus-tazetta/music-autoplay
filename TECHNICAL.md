...
Music Auto Playは、YouTubeの音楽動画をリアルタイムで管理できる機能と、学校の授業スケジュールを自動で表示・管理できる機能をひとつにまとめたWebアプリです。WebSocketによるリアルタイムな同期や、YouTube Data APIを使った動画情報の取得、授業時間の自動計算・進捗表示など、日常的に便利に使える仕組みを提供します。
